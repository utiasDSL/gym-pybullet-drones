...
this entails CPU-only PyBullet's physics updates happening at \~5000Hz (faster than [AirSim's 1000Hz](https://arxiv.org/pdf/1705.05065.pdf) and more realistic than the [30000Hz Flightmare's simple model](https://arxiv.org/pdf/2009.00563.pdf))
