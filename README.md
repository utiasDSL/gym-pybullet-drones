...
> While it is easy to—consciously or not—[cherry pick](https://en.wikipedia.org/wiki/Cherry_picking) statistics, this entails CPU-only PyBullet's physics updates at \~5kHz (faster than [AirSim's 1kHz](https://arxiv.org/pdf/1705.05065.pdf) and more accurate than the [35kHz of Flightmare's simple quadcopter dynamics](https://arxiv.org/pdf/2009.00563.pdf))
