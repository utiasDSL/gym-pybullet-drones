...
> Multi-agent 6-channel video capture at \~750kB/s with CPU rendering (`(64*48)*(4+4+2)*24*5*0.2`) is comparable to [Flightmare's 240 RGB frames/sec](https://arxiv.org/pdf/2009.00563.pdf) (`(32*32)*3*240`)—although on more complex [Unity environments](https://arxiv.org/pdf/2009.00563.pdf)—and up to an order of magnitude faster on Ubuntu, with GPU acceleration and OpenGL rendering
