"""
Began as a copy of BaseAviary class.
"""
...
class CustomBaseAviary(gym.Env):
    ...
    def _addObstacles(self):
        ...
        #            physicsClientId=self.CLIENT
        #            )
        # p.loadURDF(pkg_resources.resource_filename('gym_pybullet_drones', 'assets_obstacles/test.urdf'),
        #            physicsClientId=self.CLIENT
        #            )
