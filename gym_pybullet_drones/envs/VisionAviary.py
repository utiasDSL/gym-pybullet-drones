...
class VisionAviary(BaseAviary):
    ...
    def __init__(self, drone_model: DroneModel=DroneModel.CF2X, num_drones: int=1,
        ...
        if self.IMG_CAPTURE_FREQ%aggregate_phy_steps!=0: print("[ERROR] in VisionAviary.__init__(), aggregate_phy_steps incompatible with the desired video capture frame rate ({:f}Hz)".format(self.IMG_FRAME_PER_SEC)); exit()
