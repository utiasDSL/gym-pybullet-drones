...
def run(
    ...
    if obs == ObservationType.KIN:
        ...
        if env_name == "leaderfollower-aviary-v0":
            eval_env = make_vec_env(LeaderFollowerAviary,
                                    env_kwargs=sa_env_kwargs,
                                    n_envs=1,
                                    seed=0
                                    )
...
if __name__ == "__main__":
    ...
    parser.add_argument('--algo',       default=DEFAULT_ALGO,     type=str,             choices=['a2c', 'ppo', 'sac', 'td3'],                help='RL agent (default: ppo)', metavar='')
