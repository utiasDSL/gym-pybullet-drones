...
def run(
    ...
    INIT_XYZ, TARGET_POS_1 = pc.circle(Radius, int(NUM_WP/2), init_const)
    dont_use, TARGET_POS_2 = pc.ellipse(Radius_x=1, Radius_y=0.2,NUM_WP=int(NUM_WP/2) , init_const= 0.3)
    # dont_use, TARGET_POS_2 = pc.ellipse(Radius_x=1, Radius_y=0.2,NUM_WP=int(NUM_WP/2) , init_const= 1)
    ...
    START = time.time()
    # for i in range(0, int(duration_sec*env.SIM_FREQ)*3, AGGR_PHY_STEPS):
