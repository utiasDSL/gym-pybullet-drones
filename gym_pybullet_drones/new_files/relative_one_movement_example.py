...
def run(
    ...
    for i in range(NUM_WP):
        if i == 0:
            TARGET_POS[i, :] = INIT_XYZ[:]
        elif i < NUM_WP/3:
            TARGET_POS[i, :] = pc.relative_movement(TARGET_POS[i-1, 0], TARGET_POS[i-1, 1],TARGET_POS[i-1, 2], -0.002, 0.003, 0.004)
        elif i < 2*NUM_WP/3:
            TARGET_POS[i, :] = pc.relative_movement(TARGET_POS[i-1, 0], TARGET_POS[i-1, 1],TARGET_POS[i-1, 2], -0.002, -0.003, -0.004)
        else:
            TARGET_POS[i, :] = pc.relative_movement(TARGET_POS[i-1, 0], TARGET_POS[i-1, 1],TARGET_POS[i-1, 2], 0.004, 0, 0)
    wp_counter = 0
