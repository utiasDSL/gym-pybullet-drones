...
class HW1Control(object):
    ...
    def __init__(self, 
        ...
        self.GRAVITY = env.GRAVITY # i.e., M * g
        ...
        ####################################################################################################
        ####################################################################################################
        self.P_COEFF_POSITION = np.array([1, 1, 1]) # HOMEWORK CODE
        self.I_COEFF_POSITION = np.array([1, 1, 1]) # HOMEWORK CODE
        self.D_COEFF_POSITION = np.array([1, 1, 1]) # HOMEWORK CODE
        self.P_COEFF_ATTITUDE = np.array([1, 1, 1]) # HOMEWORK CODE
        self.I_COEFF_ATTITUDE = np.array([1, 1, 1]) # HOMEWORK CODE
        self.D_COEFF_ATTITUDE = np.array([1, 1, 1]) # HOMEWORK CODE
        ####################################################################################################
        ####################################################################################################
        ####################################################################################################
        ####################################################################################################
