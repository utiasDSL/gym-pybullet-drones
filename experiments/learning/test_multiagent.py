...
if __name__ == "__main__":
    ...
    if OBS==ObservationType.KIN: o = 12
    ...
    if ACT in [ActionType.ONE_D_RPM, ActionType.ONE_D_DYN, ActionType.ONE_D_PID]: a = 1
    elif ACT in [ActionType.RPM, ActionType.DYN]: a = 4
    elif ACT==ActionType.PID: a = 3
